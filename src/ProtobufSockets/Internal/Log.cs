...
namespace ProtobufSockets.Internal
{
    ...
    {
        private static readonly Dictionary<LogTag, TraceSource> TraceSource = new Dictionary<LogTag, TraceSource>
        {
        ...
        private static string RecoverFormat(string format, IEnumerable<object> args)
        {
